  ...
  <body>
    ...
    <?php
      ...
      if (is_numeric($_POST['year'])) {
        ...
        print '<p class ="error">Invalid year! Please enter your birth year as four digits.</p>';
        $okay = false;
      }
      
      if ($_POST['year'] >= 2026) {
        print '<p class ="error">Invalid year! Website may need update or you are from the future.</p>';
        $okay = false;
      }
