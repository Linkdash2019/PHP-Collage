#Cameron McClellan
#This should be called lab 8 not 9!
...
with open(guest_path, 'w') as file:
    file.write('')
...
def loop():
    while True:
        ...
        try:
            ...
            print('Hmmmm. Ok that checks out as a number! The sum of those two is', num_input+num_input2)
